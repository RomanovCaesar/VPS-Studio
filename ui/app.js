...
const i18n = {
  zh: {
    ...
    "z to a": "Z 到 A",
    "Search hosts...": "搜索主机...",
    "Search identities...": "搜索身份...",
    "Search keys...": "搜索密钥...",
    "Search snippets...": "搜索代码片段...",
    "Search known hosts...": "搜索已知主机...",
    "Serial": "串行端口",
    "Local terminal": "本地终端",
...
const state = {
  language: storedLanguage === "zh" || storedLanguage === "en" ? storedLanguage : "zh",
  hosts: [],
  selectedHostId: null,
  selectedGroup: null,
  openedGroup: null,
